...
<head>
<link rel="stylesheet" href="<c:url value="/assets/list.css"></c:url>">
	...
	<div class="row">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li class="active">Danh sách nhà đất</li>
			</ul>
			<div class="well well-small">
				<h1>
					Đặt lịch <small class="pull-right"> ${ TotalQuantyCart } nhà đất cần tư vấn </small>
				</h1>
				<hr class="soften" />
				...
				<table class="table table-bordered table-condensed">
					...
					<tr>
	                  <td><img width="100" src="<c:url value="/assets/image/img/${ item.value.product.id_img }"/>" alt=""></td>
	                  <td>${ item.value.product.name }</td>
	           
	                  <td>${ item.value.product.price }</td>
	                  
	                  <td>
	                  	<a href="<c:url value="/DelBooking/${ item.key }"/>" class="btn btn-mini btn-danger" type="button">
	                  		<span class="fa fa-trash" aria-hidden="true"></span>
	                  	</a>
	                  </td>
	                  <td   value="">${ item.value.totalPrice }</td>
	                </tr>
				</c:forEach>
					</tbody>
					
				</table>
				<br /> <a href="<c:url value="/trang-chu"/>" class="shopBtn btn-large"> Xem thêm bất động sản </a> <a
					href="<c:url value="/checkout"/>" class="shopBtn btn-large pull-right"> Tiến hành đặt lịch tư vấn <span ></span>
				</a>
